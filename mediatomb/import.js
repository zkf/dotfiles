...
function addDirectoryView(obj)
{
    ...
    // Location is in the form of /home/user/video/series/The Series[/season #]/episode.ext
    // Simply cut off the part before video
    for (x = 4; x < location.length-1; x++)
    {
